...
Pre_eq8(m)$(MPL(m))..      PLR(m) =l= pllll(m);
...
loop((i,j,l),mpppp(i,j,l,ss,nn) = mp.l(i,j,l););
loop(i,mmpppp(i,ss,nn) = mm.l(i););
loop(i,mappp(i,ss,nn) = ma.l(i););
loop(j,rrrrppp(j,ss,nn) = rrrr.l(j););
loop(j,rippp(j,ss,nn) = ri.l(j););
loop(m,wplpppp(m,ss,nn) = wpl.l(m););
loop(m,wasexppp(m,ss,nn) = wasex.l(m););
loop((m,n),pdppp(m,n,ss,nn) = pd.l(m,n););
loop((m,n),pcppp(m,n,ss,nn) = pc.l(m,n););
loop((m,n),PAppp(m,n,ss,nn) = PA(m,n););
loop((m,n),PWppp(m,n,ss,nn) = PW(m,n););
loop(j,RRRppp(j,ss,nn) = RRR(j););
loop(m,PLRppp(m,ss,nn) = PLR(m););
loop(m,RPLppp(m,ss,nn) = RPL(m););
loop(m,WAppp(m,ss,nn) = WA(m););
);
);

execute_unload 'results_115.gdx' npvvv envvv zzz waseee pllllll mpppp mmpppp mappp rrrrppp rippp wplpppp wasexppp pdppp pcppp PAppp PWppp RRRppp PLRppp RPLppp WAppp
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=npvvv rng=Sheet1!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=envvv rng=Sheet2!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=zzz rng=Sheet3!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=waseee rng=Sheet4!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=pllllll rng=Sheet5!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=mpppp rng=Sheet6!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=mmpppp rng=Sheet7!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=mappp rng=Sheet8!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=rrrrppp rng=Sheet9!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=rippp rng=Sheet10!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=wplpppp rng=Sheet11!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=wasexppp rng=Sheet12!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=pdppp rng=Sheet13!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=pcppp rng=Sheet14!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=PAppp rng=Sheet15!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=PWppp rng=Sheet16!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=RRRppp rng=Sheet17!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=PLRppp rng=Sheet18!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=RPLppp rng=Sheet19!';
execute 'gdxxrw.exe results_115.gdx o=results_115.xlsx par=WAppp rng=Sheet20!';
