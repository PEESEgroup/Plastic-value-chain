...
execute_unload 'results_2.gdx' npvv envv zz wasee plllll
execute 'gdxxrw.exe results_2.gdx o=results_2.xlsx par=npvv rng=NewSheet1!';
execute 'gdxxrw.exe results_2.gdx o=results_2.xlsx par=envv rng=NewSheet2!';
execute 'gdxxrw.exe results_2.gdx o=results_2.xlsx par=zz rng=NewSheet3!';
execute 'gdxxrw.exe results_2.gdx o=results_2.xlsx par=wasee rng=NewSheet4!';
execute 'gdxxrw.exe results_2.gdx o=results_2.xlsx par=plllll rng=NewSheet5!';
$offText
...
execute_unload 'results_6.gdx' npvvv envvv zzz waseee pllllll
execute 'gdxxrw.exe results_6.gdx o=results_6.xlsx par=npvvv rng=NewSheet1!';
execute 'gdxxrw.exe results_6.gdx o=results_6.xlsx par=envvv rng=NewSheet2!';
execute 'gdxxrw.exe results_6.gdx o=results_6.xlsx par=zzz rng=NewSheet3!';
execute 'gdxxrw.exe results_6.gdx o=results_6.xlsx par=waseee rng=NewSheet4!';
execute 'gdxxrw.exe results_6.gdx o=results_6.xlsx par=pllllll rng=NewSheet5!';
