...
execute_unload 'results_5.gdx' npvvv envvv zzz waseee pllllll
execute 'gdxxrw.exe results_5.gdx o=results_5.xlsx par=npvvv rng=NewSheet1!';
execute 'gdxxrw.exe results_5.gdx o=results_5.xlsx par=envvv rng=NewSheet2!';
execute 'gdxxrw.exe results_5.gdx o=results_5.xlsx par=zzz rng=NewSheet3!';
execute 'gdxxrw.exe results_5.gdx o=results_5.xlsx par=waseee rng=NewSheet4!';
execute 'gdxxrw.exe results_5.gdx o=results_5.xlsx par=pllllll rng=NewSheet5!';
